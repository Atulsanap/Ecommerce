...
namespace Ecommerce
{
    public class Startup
    {
      ...
      //services.AddSingleton<IDbOpertaions,DbOperation>();
      ...
      app.UseCors(options => options.WithOrigins("http://localhost:4200").AllowAnyMethod().AllowAnyHeader().AllowCredentials().SetIsOriginAllowed((host) => true));
